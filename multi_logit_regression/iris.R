...
data_i_i2 <- list(D=D_i_i, N=N, K=K, x=x_i_i, y=y)

model_2_2 <- cmdstan_model("multi_logit_regression_dummy_i_i2.stan")

fit_2_2 <- model_2_2$sample(data = data_i_i2,
                            output_dir = "output",validate_csv = FALSE)
//print(fit_1$summary())
print(rstan::read_stan_csv(fit_2_2$output_files()))
